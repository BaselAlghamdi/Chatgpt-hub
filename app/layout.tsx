...
export const metadata:Metadata={title:{default:'Basel Alghamdi | Research & Projects',template:'%s | Basel Alghamdi'},description:'Financial research, valuation models, and projects by Basel Alghamdi, a finance student at King Abdulaziz University.',icons:{icon:'/portfolio-icon.svg?v=3',apple:'/apple-icon.png?v=3'},robots:{index:true,follow:true}};
